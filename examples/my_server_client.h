...
#include <cnr_ipnc_utilities/asio_ipnc.h>
...
class MyServer : public std::enable_shared_from_this<MyServer>
{
 public:
      ...
      : config_(config)
  {
    try
    {
      ...
      set_server_ = cnr::ipnc::make_shared(
      ...
      get_server_ = cnr::ipnc::make_shared(
 ...
 private:
  ...
  std::shared_ptr<cnr::ipnc::AsioServer> set_server_;
  std::shared_ptr<cnr::ipnc::AsioServer> get_server_;
};
